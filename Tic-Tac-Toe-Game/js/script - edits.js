...
---------------------------------------------------------------------------------------------------------*/
  ...
  function computersPick(){
      ...
      if(availableChoices.includes(checkTwoInRow(computerSelections)) === true)
      {
      ...
      else if(counter == 2 && availableChoices.includes(5) === true && (player1Selections.includes(1) || player1Selections.includes(3) || player1Selections.includes(7) || player1Selections.includes(9)))
      {
        boxNumber = 5;
        console.log("Blocks opponents fork");
      }
      // step 5: The computer marks the center if they have first move. (If it is the first move of the game, playing on a corner gives the second
      //player more opportunities to make a mistake and may therefore be the better choice; however, it makes no difference
